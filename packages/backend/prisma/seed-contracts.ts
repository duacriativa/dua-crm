...
async function main() {
  ...
  const contracts = [
    ...
    },
    {
      ...
      serviceType: ContractServiceType.SOCIAL_MEDIA,
      description: 'Rede Social + creators — voltou em abr/2026 (foi cliente por 1 mês em 2025)',
      monthlyValue: 2500,
      totalValue: 2500 * 6,
      installments: 1,
      signedAt: new Date('2026-04-20'),
      startsAt: new Date('2026-04-20'),
      endsAt: new Date('2026-10-20'),
      notes: 'Reativação — foi cliente por 1 mês em 2025, voltou em abril/2026. Pagou R$2.500 dia 20/04.',
    },
    {
      clientName: 'Mandi',
