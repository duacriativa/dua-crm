            ...
            {showAddStage ? (
              <div className="bg-card rounded-2xl p-4 border border-primary/30 shadow-sm">
                ...
                <input autoFocus value={newStageName} onChange={(e) => setNewStageName(e.target.value)}
                  ...
                  className="w-full text-sm border border-border rounded-lg px-3 py-2 mb-3 focus:outline-none focus:ring-2 focus:ring-brand-500 bg-background text-foreground placeholder:text-muted-foreground" />
